...
export const BOARD_LOCATIONS: BoardLocation[] = [
  // --- STARFATORG / Employment District ---
  {
    ...
    actions: [
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Skoða laus störf og sækja um' },
    ],
  },
  ...
  // --- VINNUSTAÐIR / Workplaces ---
  {
    ...
    jobIds: ['programmer', 'senior_developer', 'cto'],
    actions: [
      { type: 'work', label: 'Vinna', timeCost: 6, description: 'Vinna daginn' },
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Sækja um starf hér' },
    ],
  },
  {
    id: 'hospital',
    ...
    jobIds: ['nurse', 'doctor'],
    actions: [
      { type: 'work', label: 'Vinna', timeCost: 7, description: 'Vinna vakt' },
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Sækja um starf hér' },
    ],
  },
  {
    id: 'office_building',
    name: 'Skrifstofubygging',
    type: 'workplace',
    icon: '🏬',
    description: 'Almenn skrifstofuvinna og stjórnun',
    position: { x: 3, y: 3 },
    linkedLocationIds: ['employment_office', 'social_club'],
    jobIds: ['office_worker', 'accountant', 'manager'],
    actions: [
      { type: 'work', label: 'Vinna', timeCost: 6, description: 'Vinna daginn' },
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Sækja um starf hér' },
    ],
  },
  {
    ...
    jobIds: ['cashier', 'waiter'],
    actions: [
      { type: 'work', label: 'Vinna', timeCost: 6, description: 'Vinna vakt' },
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Sækja um starf hér' },
    ],
  },
  {
    ...
    type: 'workplace',
    icon: '📚',
    description: 'Kennsla og menntun ungmenna',
    position: { x: 5, y: 1 },
    linkedLocationIds: ['employment_office', 'university'],
    jobIds: ['teacher'],
    actions: [
      { type: 'work', label: 'Vinna', timeCost: 6, description: 'Kenna í dag' },
      { type: 'apply_job', label: 'Sækja um starf', timeCost: 2, description: 'Sækja um kennarastöðu' },
    ],
  },
  ...
  // --- MENNTUN / Education ---
  {
    ...
    actions: [
      { type: 'study', label: 'Stunda nám', timeCost: 4, moneyCost: 800, description: 'Taka áfanga í háskóla' },
    ],
  },
  {
    id: 'library',
    ...
    actions: [
      { type: 'study', label: 'Lesa og læra', timeCost: 2, description: 'Sjálfstætt nám, hægara en skóli en frítt' },
      { type: 'practice_hobby', label: 'Skrifa', timeCost: 2, description: 'Æfa hobbyið "skrif"' },
    ],
  },
  {
    id: 'online_courses',
    ...
    actions: [
      { type: 'study', label: 'Taka námskeið', timeCost: 3, moneyCost: 300, description: 'Fljótlegra en skóli en minna þekking' },
    ],
  },
  ...
  // --- ÍBÚÐAR / Housing ---
  {
    ...
    actions: [
      ...
      { type: 'upgrade_housing', label: 'Flytja í betri íbúð', timeCost: 1, moneyCost: 5000, description: 'Uppfæra til miðlungs íbúðar' },
    ],
  },
  {
    id: 'apartment_mid',
    ...
    actions: [
      ...
      { type: 'upgrade_housing', label: 'Flytja í lúxus íbúð', timeCost: 1, moneyCost: 20000, description: 'Uppfæra í bestu íbúð' },
    ],
  },
  {
    id: 'apartment_luxury',
  ...
  // --- FÉLAGSLEGAR STAÐIR / Social ---
  {
    ...
    actions: [
      { type: 'socialize', label: 'Hittast við vini', timeCost: 2, description: '+tengsl, +líðan, -streita' },
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 'practice_hobby', label: 'Líkamsrækt úti', timeCost: 2, description: 'Hlaup eða útivera' },
    ],
  },
  ...
  // --- HOBBY STAÐIR ---
  {
    ...
    actions: [
      { type: 'exercise', label: 'Þjálfa', timeCost: 2, moneyCost: 200, description: '+líðan, -streita, +heilsa' },
      { type: 'practice_hobby', label: 'Æfa íþrótt', timeCost: 2, description: 'Æfa hobby "líkamsrækt"' },
    ],
  },
  {
    id: 'music_studio',
    ...
    actions: [
      { type: 'practice_hobby', label: 'Æfa tónlist', timeCost: 2, description: '+xp í tónlist hobby' },
      { type: 'group_session', label: 'Hljómsveitar æfing', timeCost: 2, description: 'Æfa með hljómsveitar hóp' },
    ],
  },
  {
    id: 'art_studio',
    ...
    actions: [
      { type: 'practice_hobby', label: 'Vinna að list', timeCost: 2, description: '+xp í list eða skrif hobby' },
      { type: 'group_session', label: 'Listahópur', timeCost: 2, description: 'Vinna með listahóp' },
    ],
  },
]
