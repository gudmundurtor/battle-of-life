...
export const en: Translations = {
  lobby: {
    ...
    short: 'Short',
    long: 'Long',
    rivalDifficulty: 'Georg difficulty',
    easy: 'Easy',
    mediumDiff: 'Medium',
    hard: 'Hard',
    goalCountLabel: 'Number of goals',
    goalsN: (n) => `${n} goals`,
    rivalCompetes: 'Georg competes against you',
    rivalCompetesDesc: 'An AI rival who competes against you',
  ...
  online: {
    ...
    createDesc: 'Start a game and invite others',
    joinGame: 'Join game',
    joinDesc: 'Enter a code from a friend',
    ...
    goalsLocked: 'Your goals are locked in',
  },
  ...
  actionMsg: {
    ...
    actionUnavailable: 'Action not available here',
    notEnoughTime: 'Not enough time',
    notEnoughMoney: 'Not enough money',
    notWorking: "You don't have a job",
    workplaceNotFound: 'Workplace not found',
    hobbyNotFound: 'Hobby not found',
    dishNotFound: 'Dish not found',
    unknownAction: 'Unknown action',
    socialized: 'Met up with friends',
    rested: 'Rested well',
    exercised: 'Went to the gym',
    boughtClothes: 'Bought new clothes',
    boughtFood: 'Bought groceries',
    upgradedHousing: 'Moved to a better home',
    groupSession: 'Practiced with a group',
    formedGroup: 'Formed a group',
    joinedGroup: 'Joined a group',
    worked: (title: string) => `Worked as ${title}`,
    studied: (amount: number) => `Studied — knowledge +${amount}`,
    practiced: (name: string) => `Practiced ${name}`,
    boughtMeal: (name: string) => `Bought ${name}`,
    error: 'Error',
  },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'In single player, Georg (AI) competes against you.',
        ],
      },
    ],
  },
