...
export const is: Translations = {
  ...
  online: {
    modeLocal: 'Á þessu tæki',
    modeOnline: 'Yfir netið',
    yourName: 'Nafnið þitt',
    createGame: 'Stofna leik',
    createDesc: 'Búðu til leik og bjóddu öðrum',
    joinGame: 'Taka þátt',
    joinDesc: 'Sláðu inn kóða frá vini',
    roomCodePlaceholder: 'Leikkóði',
    create: 'Stofna →',
    join: 'Taka þátt →',
    or: 'eða',
    connecting: 'Tengist...',
    waitingRoomTitle: 'Biðstofa',
    roomCodeLabel: 'Leikkóði',
    inviteLink: 'Hlekkur til að bjóða',
    copy: 'Afrita',
    copied: 'Afritað!',
    host: 'Gestgjafi',
    you: 'Þú',
    waitingForPlayers: 'Bíð eftir leikmönnum...',
    needMorePlayers: 'Þarf a.m.k. 2 leikmenn',
    waitingForHost: 'Bíð eftir að gestgjafi hefji leik...',
    start: 'Hefja leik →',
    leave: 'Hætta',
    errNotFound: 'Leikur fannst ekki',
    errFull: 'Leikurinn er fullur',
    errAlreadyStarted: 'Leikurinn er þegar byrjaður',
    errGeneric: 'Eitthvað fór úrskeiðis',
    waitingForOthers: 'Bíð eftir öðrum leikmönnum...',
    goalsLocked: 'Markmið þín eru valin',
  },
